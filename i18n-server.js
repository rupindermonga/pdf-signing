...
const translations = {
  en: {
    'email.login_subject': 'Your SealForge login verification code',
    ...
    'email.signer_subject': 'Your SealForge verification code',
    ...
    'email.invite_subject': '{inviter} invited you to join {org} on SealForge',
    ...
    'sms.otp': 'Your SealForge code: {code}',
  },
  fr: {
    'email.login_subject': 'Votre code de vérification SealForge',
    ...
    'email.signer_subject': 'Votre code de vérification SealForge',
    ...
    'email.invite_subject': '{inviter} vous invite à rejoindre {org} sur SealForge',
    ...
    'sms.otp': 'Votre code SealForge : {code}',
  },
  hi: {
    'email.login_subject': 'आपका SealForge लॉगिन सत्यापन कोड',
    ...
    'email.signer_subject': 'आपका SealForge सत्यापन कोड',
    ...
    'email.invite_subject': '{inviter} ने आपको SealForge पर {org} में शामिल होने के लिए आमंत्रित किया',
    ...
    'sms.otp': 'आपका SealForge कोड: {code}',
  },
};
